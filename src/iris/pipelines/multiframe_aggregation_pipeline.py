...
from iris.orchestration.output_builders import __get_error, build_orb_output, build_simple_debugging_output
...
class MultiframeAggregationPipeline(Algorithm):
    ...
    def run(self, templates: List[IrisTemplate]) -> Any:
        """Generate template.
